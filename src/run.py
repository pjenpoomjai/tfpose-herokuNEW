...
if __name__ == '__main__':
    ...
    parser.add_argument('--image', type=str, default='yoga.jpg')
    ...
    #pose_3d contain [x,y,z]  x 17 points , y 17 points , z 17 points
    #mean  point [x,y,z] each part of body
    #Matt plot lib
    print('test',pose_3d[0])
    #----------------------------------------
    #pyQT graph
    pose_3dqt = np.array(pose_3d[0]).transpose()
    bodyPartName = ['C_Hip','R_Hip',
                    'R_Knee','R_Ankle','L_Hip',
                    'L_Knee','L_Ankle','Center',
                    'C_Shoulder','Neck','Head',
